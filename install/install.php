...
if ( empty($_POST['step']) ) {
	...
	$queries[] = "INSERT INTO ".$dbs['prefix']."posts ( topic_id, poster_guest, poster_ip_addr, content, post_time ) VALUES ( '1', 'UseBB Team', '127.0.0.1', 'Thanks for choosing UseBB! We wish you a lot of fun with your board!', '".time()."' )";
