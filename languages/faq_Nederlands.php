...
$faq[] = array('What are the benifits of registering?', 'First of all, you get a personal account with your nickname which will be only available to you. You also get a personal profile where you can give some additional information about yourself if you like and you can adjust the forum to your wishes via the Edit Options feature, which may also include choosing a language and template setting.');
$faq[] = array('What do I need to register an account?', 'To register, you need to choose a nickname (username) which will be the key to your account. If you like, you can also use your real name instead of your nickname. Note you can\'t change your username by yourself after registering. You also need to have a working e-mail address (as it may be required to activate your account) and you have to choose a password (which you can change afterwards).');
$faq[] = array('What if I forget my password or my e-mail address doesn\'t work anymore?', 'You can always request a new password via the link on the login form. If your e-mail address doesn\'t work anymore, contact an administrator. He/she may adjust your account to your new and working e-mail address.');
