...
$faq[] = array('Hoef ik me te registreren?', 'Registratie kan vereist zijn om berichten in dit forum te plaatsen, dit hangt af of de administratoren het plaatsen van berichten door gasten toestaan (dit kan afzonderlijk per forum zijn). Over het algemeen is registreren een goed idee omdat het veel extra mogelijkheden biedt.');
