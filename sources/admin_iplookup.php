...
$content .= '<form action="'.$functions->make_url('admin.php', array('act' => 'iplookup')).'" method="post"><p>'.$lang['IPAddress'].': <input type="text" name="ip" /> <input type="submit" value="'.$lang['OK'].'" /></p></form>';
