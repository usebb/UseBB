...
//
if ( !defined('IS_RSS') && ( !defined('IS_CSS') || stristr($_SERVER['HTTP_USER_AGENT'], 'Gecko') ) && ( $functions->get_config('output_compression') === 2 || $functions->get_config('output_compression') === 3 ) && !ini_get('zlib.output_compression') )
